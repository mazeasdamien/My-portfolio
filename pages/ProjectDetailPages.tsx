  ...
  <ProjectLayout title="Human-Computer Interaction" subtitle="Course Design • BNBU • 2025">
    <div className="lg:col-span-7 flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 gap-4">
        <ZoomableImage src="images/portfolio/hcicouse/hci1.webp" alt="HCI Course Hero" className="aspect-video rounded-lg" />
        <div className="grid grid-cols-2 gap-4">
           <ZoomableImage src="images/portfolio/hcicouse/hci3.webp" alt="User Studies" className="aspect-square rounded-lg" />
           <ZoomableImage src="images/portfolio/hcicouse/hci4.webp" alt="Ergonomics" className="aspect-square rounded-lg" />
        </div>
      </div>
    ...
    <div className="lg:col-span-5 space-y-12">
       ...
       <div className="bg-neutral-50 p-6 rounded-xl border border-neutral-100">
           ...
           <dl className="space-y-3 text-sm">
               <div><dt className="font-bold text-neutral-900">Code</dt><dd className="text-neutral-600">A13153</dd></div>
