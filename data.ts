...
export const portfolioData: PortfolioItem[] = [
  ...
  },
  {
    ...
    authors: '<strong class="text-[rgb(9,172,239)]">D Mazeas</strong>, B Namoano',
  },
  {
    category: 'teaching',
    date: '2025-02-01',
  ...
  },
  {
    ...
    authors: 'SCM Galvis*, <strong class="text-[rgb(9,172,239)]">D Mazeas*</strong>, F Noel, JA Erkoyuncu (*Equal contribution)',
    mainProject: true,
  ...
  },
  {
    ...
    subtitle: 'PhD Thesis.',
    authors: '<strong class="text-[rgb(9,172,239)]">D Mazeas</strong>',
  },
  {
    category: 'degree',
    date: '2024-04-01',
  ...
  },
  {
    ...
    authors: '<strong class="text-[rgb(9,172,239)]">D Mazeas</strong>, JA Erkoyuncu, F Noel',
  },
  {
    category: 'publication',
    date: '2023-02-01',
  ...
  },
  {
    ...
    date: '2023-01-01',
    displayDate: '2023',
    title: 'Telexistence for Remote Maintenance',
    subtitle: 'Research',
    description: 'VR-based telexistence system allowing maintainer to perform remote inspections and maintenance with spatial presence.',
  ...
  },
  {
    ...
    authors: 'S Stadler, H Cornet, <strong class="text-[rgb(9,172,239)]">D Mazeas*</strong>, JR Chardonnet, F Frenkler (*App development, experiment design, data collection, and analysis)',
  },
  {
    category: 'employment',
    date: '2020-03-01',
  ...
  },
  {
    ...
    subtitle: 'Research',
    description: 'Virtual reality application enabling industrial designers to prototype and ideate quickly in immersive environments.',
  ...
  },
  {
    ...
    subtitle: 'Projects',
    description: 'VR applications developed during master studies, focusing on industrial use cases in partnership with companies.',
